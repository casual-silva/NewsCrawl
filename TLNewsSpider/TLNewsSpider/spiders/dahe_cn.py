...
class DaheCnSpider(scrapy.Spider):
    name = 'dahe.cn'
    ...
    # 分析链接页面之间相似性 分组抓取
    start_urls = [
        ["行业舆情", "首页>金融>财经要闻", "https://jr.dahe.cn/cjyw/"],
        ["行业舆情", "首页>金融>银行资讯", "https://jr.dahe.cn/cjyhzx/"],
        ["地区舆情", "首页>金融>河南财经", "https://jr.dahe.cn/hncj/"]
    ]
    ...
    def parse(self, response):
        ...
        for url in response.css(".newsleftul li a"):
