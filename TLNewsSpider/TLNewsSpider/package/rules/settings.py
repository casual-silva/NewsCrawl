...
PUBLISH_TITLE_META = [ # 部分特别规范的新闻网站，可以直接从 HTML 的 meta 数据中获得标题
    ...
    '//meta[starts-with(@property, "title")]/@content',
    '//meta[starts-with(@itemprop, "Title")]/@content',
    '//meta[starts-with(@itemprop, "title")]/@content',
    '//meta[starts-with(@itemprop, "articleaitle")]/@content',
    '//meta[starts-with(@itemprop, "ArticleTitle")]/@content',
]
