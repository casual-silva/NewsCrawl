...
class SouthmoneyComSpider(scrapy.Spider):
    name = 'southmoney.com'
    ...
    # 分析链接页面之间相似性 分组抓取
    start_urls = [
        ["企业舆情", "首页 > 财经 > 公司新闻", "http://www.southmoney.com/caijing/gongsixinwen/"]
    ]
    ...
    def parse(self, response):
        # 详情页
        yield from self.parse_southmoney(response)

    # 首页>基金
    def parse_southmoney(self, response):
    ...
    def parse_detail(self, response):
        ...
        content=response.xpath('//*[@class="articleCon"]/p[not(@class)]//text()').getall()
