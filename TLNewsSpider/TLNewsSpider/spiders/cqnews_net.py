...
class CqnewsNetSpider(scrapy.Spider):
    name = 'cqnews.net'
    ...
    # 分析链接页面之间相似性 分组抓取
    start_urls = [
        ["企业舆情", "首页>新闻", "http://news.cqnews.net/"]
    ]
    ...
    def parse(self, response):
        # 详情页
        for url in response.css(".gnkd_tit h1 a"):
    ...
    def parse_detail(self, response):
        ...
        # 自定义规则
        item.add_xpath('article_source', '//*[@class="author"]/a/text()')  # 来源/article_source
