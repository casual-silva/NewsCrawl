...
class PedailyCnSpider(scrapy.Spider):
    name = 'pedaily.cn'
    ...
    # 分析链接页面之间相似性 分组抓取
    start_urls = [
        ['企业舆情', '投资界 >IPO前线', 'https://www.pedaily.cn/exit/']
    ]
    ...
    def parse_detail(self, response):
        ...
        item.add_xpath('author', '//*[@class="author"]/text()')  # 作者/author
        # 默认保存一般无需更改
