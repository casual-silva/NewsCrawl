...
class EduZjolComCnSpider(scrapy.Spider):
    name = 'edu.zjol.com.cn'
    allowed_domains = ['edu.zjol.com.cn']
    site_name = '浙江在线教育'
    ...
    # 分析链接页面之间相似性 分组抓取
    start_urls = [
        ["地区舆情", "首页>新闻>教育发布", "http://edu.zjol.com.cn/jyjsb/jyfb/"]
    ]
    ...
    def parse(self, response):
        # 详情页
        for data in response.xpath('//*[@class="listUl"]/li'):
