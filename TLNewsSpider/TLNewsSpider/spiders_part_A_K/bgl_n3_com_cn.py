...
class BglN3ComCnSpider(scrapy.Spider):
    name = 'bgl.n3.com.cn'
    allowed_domains = ['bgl.n3.com.cn']
    site_name = '暖立方'
    ...
    # 分析链接页面之间相似性 分组抓取
    start_urls = [
        ["行业舆情", "首页 > 壁挂炉网 > 行业动态", "http://bgl.n3.com.cn/list.php?catid=725"],
        ["行业舆情", "首页 > 壁挂炉网 > 企业新闻", "http://bgl.n3.com.cn/list.php?catid=730"]
    ]
    ...
    def parse_detail(self, response):
        ...
        item.add_xpath('content_text', '//*[@id="article"]/p//text()|//*[@id="article"]/span//text()')  # 正文内容/text_content
