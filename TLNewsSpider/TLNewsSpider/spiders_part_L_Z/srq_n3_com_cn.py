...
class SrqN3ComCnSpider(scrapy.Spider):
    name = 'srq.n3.com.cn'
    allowed_domains = ['srq.n3.com.cn']
    site_name = '暖立方'
    ...
    # 分析链接页面之间相似性 分组抓取
    start_urls = [
        ["行业舆情", "首页 > 散热器网 > 行业动态", "http://srq.n3.com.cn/list.php?catid=1629"],
        ["行业舆情", "首页 > 散热器网 > 企业新闻", "http://srq.n3.com.cn/list.php?catid=1628"]
    ]
