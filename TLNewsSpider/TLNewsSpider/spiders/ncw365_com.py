...
class Ncw365ComSpider(scrapy.Spider):
    name = 'ncw365.com'
    allowed_domains = ['ncw365.com']
    site_name = '农财网'
    ...
    # 分析链接页面之间相似性 分组抓取
    start_urls = [
        ["企业舆情", "农财网 > 头条新闻", "http://www.ncw365.com/html/inongcai/zx/yybtt/"]
    ]
    ...
    def parse(self, response):
        for url in response.css(".ns-pot h4 a"):
