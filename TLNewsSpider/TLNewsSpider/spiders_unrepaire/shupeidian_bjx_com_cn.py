...
class ShupeidianBjxComCnSpider(scrapy.Spider):
    name = 'shupeidian.bjx.com.cn'
    allowed_domains = ['shupeidian.bjx.com.cn']
    site_name = '北极星输配电网'
    ...
    # 分析链接页面之间相似性 分组抓取
    start_urls = [
        ["企业舆情", "北极星输配电网  > 企业", "https://shupeidian.bjx.com.cn/NewsList?id=76"]
    ]
    ...
    def parse_jijing(self, response):
        ...
        next_url = f"https://shupeidian.bjx.com.cn{page}"
        response.meta['num'] += 1
